...
export default function Edit({ auth, colaborador, escalas }) {
  ...
  const onSubmit = e => {
    ...
    patch(route("colaboradors.store"), {
      preserveScroll: true,
      onSuccess: () => reset(),
      onError: errors => {
        if (errors.nome) {
        ...
        header={
          <>
            <h2 className="font-semibold text-xl text-gray-800 leading-tight">
              Edição - Colaborador - {colaborador.id}
            </h2>
          </>
        }
      >
              ...
              <form onSubmit={onSubmit} className="mt-6 space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    defaultValue={colaborador.escala_trabalho_id}
                  >
                    <option>Selecione uma Escala</option>
                    {escalas.map(escala => {
                      return (
